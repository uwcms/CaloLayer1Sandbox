...
public:
  ...
  // virtual  UCT2016Layer1CTP7(uint32_t phi) = 0;
  ...
  virtual bool getConfiguration(UCT2016Layer1RunMode &m, std::string &output) = 0;
  virtual bool setConfiguration(UCT2016Layer1RunMode mode, std::string input) = 0;
