#ifndef UCT2016Layer1CTP7Client_hh
#define UCT2016Layer1CTP7Client_hh

#include "UCT2016Layer1CTP7.hh"

class UCT2016Layer1CTP7Client : public UCT2016Layer1CTP7 {

public:

  UCT2016Layer1CTP7Client(uint32_t phi = 0) : myPhi(phi) {;}

  virtual ~UCT2016Layer1CTP7Client() {;}

  bool getPhi(uint32_t &phi) {phi = myPhi; return true;}

  bool checkConnection() {return true;}

  bool getConfiguration(UCT2016Layer1RunMode &m, std::string &output) {return true;}
  bool setConfiguration(UCT2016Layer1RunMode mode, std::string input) {return true;}
